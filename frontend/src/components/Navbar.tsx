...
const Navbar = () => {
    ...
    return (
        <header>
            <nav className="sticky top-0 z-50 flex items-center justify-between  px-5 py-2 sm:px-10 sm:py-3 lg:px-15 bg-white/10 backdrop-blur-xl border-b border-white/20">
